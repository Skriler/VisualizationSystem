...
{
    public double CalculateEuclidean(List<NormalizedNodeParameter> firstParameters, List<NormalizedNodeParameter> secondParameters)
    {
    ...
    public double CalculateEuclidean(List<NormalizedNodeParameter> firstParameters, List<double> secondParameters)
    {
        return CalculateWeightedEuclidean(firstParameters, secondParameters);
    }

    private double CalculateWeightedEuclidean(List<NormalizedNodeParameter> parameters, List<double> values)
    {
        ...
        for (int i = 0; i < parameters.Count; ++i)
        {
            ...
            distance += (diff * diff) * parameters[i].Weight;
        }
